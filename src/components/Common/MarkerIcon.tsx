export const MarkerIcon = ({ fill }: { fill?: string }) => {
    return <div>
        <svg fill={fill || "#000"} height="15px" width="15px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
